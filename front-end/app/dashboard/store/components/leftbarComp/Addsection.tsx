  ...
  return (
    <div>
      ...
      <div className="py-2 mt-2 flex flex-col gap-2">
        <div
          draggable
          className="bg-white text-gray-700 duration-300 border hover:bg-primary hover:text-white rounded-md cursor-move hover:shadow-md p-4 w-full"
        >
          <h3>Header</h3>
          <p className="text-sm">the header section</p>
        </div>
